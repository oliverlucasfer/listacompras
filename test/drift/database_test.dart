...
void main() {
  ...
  test('deve_inserir_e_ler_lista_quando_crud_valido', () async {
    ...
    final lista = await (db.select(db.listaLocal)
          ..where((l) => l.id.equals('11111111-1111-1111-1111-111111111111')))
        .getSingle();
  ...
  test('deve_atualizar_titulo_e_soft_delete_quando_editado', () async {
    ...
    await (db.update(db.listaLocal)
          ..where((l) => l.id.equals('22222222-2222-2222-2222-222222222222')))
        .write(ListaLocalCompanion(
  ...
  test('deve_inserir_item_vinculado_e_filtrar_por_lista_quando_consulta', () async {
    await db.batch((b) {
      b.insert(db.listaLocal, ListaLocalCompanion.insert(
      ...
      b.insert(db.itemLocal, ItemLocalCompanion.insert(
    ...
    final itens = await (db.select(db.itemLocal)
          ..where((i) => i.listaId.equals('33333333-3333-3333-3333-333333333333'))
  ...
  test('deve_enfileirar_e_remover_mutacao_quando_escrita_pendente', () async {
    await db.into(db.mutacaoPendente).insert(
    ...
    await (db.delete(db.mutacaoPendente)
          ..where((m) => m.id.equals(fila.single.id)))
        .go();
  ...
  test('deve_cascata_item_quando_lista_excluida_localmente', () async {
    ...
    await (db.delete(db.listaLocal)
          ..where((l) => l.id.equals('66666666-6666-6666-6666-666666666666')))
        .go();

    expect(
      await (db.select(db.itemLocal)
            ..where((i) =>
                i.listaId.equals('66666666-6666-6666-6666-666666666666')))
          .get(),
      isEmpty,
    );
  });
