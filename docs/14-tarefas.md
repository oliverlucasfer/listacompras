...
- [x] **F39-T01** — Planejamento: Fase 39 e rastreabilidade no RNF-08
...
- [x] **F39-T02** — Shared kernel: `lib/core/dominio/`
...
- [x] **F39-T03** — Providers de rede para `providers/`
...
- [x] **F39-T04** — Deduplicação: `emailValido` e `Papel.rotulo`
  Dep: F39-T02 · Docs: [05 §2](05-app-flutter.md)
